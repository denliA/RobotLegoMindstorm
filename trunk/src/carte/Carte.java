...
public class Carte {
	 ...
	 * Elle renvoie une erreur lorsque les 2 lignes sont parallËles.
	 * @param l1
	 * @param l2
	 */
	public void traverseIntersection(Ligne l1, Ligne l2) throws CalibrageException{
		if(!(l1.getDirection()^l2.getDirection())) {
			throw new CalibrageException("Les deux lignes sont parallËles, elles n'ont pas d'interseciton.");
		}
		else {
			if(l1.getDirection()) {
