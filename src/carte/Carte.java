...
public class Carte {
	 ...
	 * On calibre cette Carte à chaque fois que le robot travers une ligne, une intersection, ou reçoit une information comme le contact, ou encore l'abscence d'un palet.
	 ...
	 * L'utilité de cette classe est que lorsque le robot a besoin d'une information, il peut se baser sur la dernière version de la carte qu'il a (la dernière mise à jour qu'il a effectué).
